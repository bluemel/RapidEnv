...
public class RapidEnvInterpreterTest {
	...
	@Before
	public void setUp() {
		File testinstall = new File("target/testinstall");
		if (testinstall.exists()) {
			FileHelper.deleteDeep(testinstall, true);
		}
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath04.xml", "i" }));
	...
	public void testCreateConfigurationWindowsSimple() {
		...
		final File testinstall = new File("target/testinstall");
		final File mysqlbin = new File("target/testinstall/mysql/5.5.15/bin");
		if (!mysqlbin.exists()) {
			assertTrue(mysqlbin.mkdirs());
		}
		FileHelper.copyFile(new File("src/test/resources/conf/mysql/mysql.ico"),
				new File("target/testinstall/mysql/5.5.15/bin/mysql.ico"), true);
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envIcon01.xml", "c" }));
		...
		try {
			...
			assertEquals(new File(unitMysql.getHomedir() + "/bin").getAbsolutePath(),
					shellLinkWinRead.getWorkingDirectory().getAbsolutePath());
			assertEquals(new File(unitMysql.getHomedir() + "/bin/mysql.ico").getAbsolutePath(),
					shellLinkWinRead.getIconFile().getAbsolutePath());
	...
	public void testCreateConfigurationWindowsCmd() {
		...
		FileHelper.copyFile(new File("src/test/resources/conf/mysql/mysql.ico"),
				new File("target/testinstall/mysql/5.5.15/bin/mysql.ico"), true);
		FileHelper.copyFile(new File("src/test/resources/conf/mysql/mysqld_start.cmd"),
				new File("target/testinstall/mysql/5.5.15/bin/mysqld_start.cmd"), true);
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envIcon01.xml", "c" }));
		ByteArrayOutputStream bStream = new ByteArrayOutputStream();
		PrintStream sout = new PrintStream(bStream);
		...
		try {
			...
			assertEquals(new File(unitMysql.getHomedir() + "/bin/mysqld_start.cmd").getAbsolutePath(),
					shellLinkWinRead.getArguments().get(2).getValue());
	...
	public void testCreateConfigurationWindowsCmdenv() {
		...
		try {
			...
			assertEquals(new File(unitMysql.getHomedir() + "/bin/mysqld_start.cmd").getAbsolutePath(),
					shellLinkWinRead.getArguments().get(5).getValue());
	...
	public void testParsePropertyConfigurationsSimple() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "b" }));
	...
	public void testParsePropertyConfigurationsToolSpecific() throws IOException {
		...
		if (new File("target/testinstall").exists()) {
			FileHelper.deleteDeep(new File("target/testinstall"));
		}
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "s" }));
		RapidEnvInterpreter.clearInstance();

		try {

			// boot that thing
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "b" }));
			...
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificBootWin.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificBootWin.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificBootWin.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificBootLinux.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificBootLinux.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificBootLinux.cmd"), env.getProfileCmd());
				break;
			default:
			...
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificStatWin.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificBootWin.properties"),
						env.getProfileProps());
				...
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificStatLinux.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificBootLinux.properties"),
						env.getProfileProps());
			...
			sout = new PrintStream(bStream);
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "i" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificInstWin.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWin.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWin.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificInstLinux.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinux.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinux.cmd"), env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not yet tested");
			}
			...
			env = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "i", "otherapp" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificInstSpecWin.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWinSpec.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWinSpec.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificInstSpecLinux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinuxSpec.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinuxSpec.cmd"),
						env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not yet tested");
			...
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificStat2Win.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWinSpec.properties"),
						env.getProfileProps());
			...
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificStat2Linux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinuxSpec.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
			...
			sout = new PrintStream(bStream);
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "c" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificConfWin.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWinSpec.properties"),
						env.getProfileProps());
				...
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificConfLinux.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinuxSpec.properties"),
						env.getProfileProps());
			...
			sout = new PrintStream(bStream);
			env = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "c", "myapp.home" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificConfcWin.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstWinSpec.properties"),
						env.getProfileProps());
			...
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificConfcLinux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInstLinuxSpec.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
			...
			sout = new PrintStream(bStream);
			env = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "src/test/resources/env/envPropsToolSpecific.xml", "c", "otherapp.data" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificConfpWin.txt"),
						bStream);
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificConfpLinux.txt"), bStream);
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not yet tested");
			}
			...
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"src/test/resources/env/envPropsToolSpecific.xml", "d", "myapp", "otherapp" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificDeinstWin.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificDeinstWin.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificDeinstWin.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificDeinstLinux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificDeinstLinux.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificDeinstLinux.cmd"), env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not yet tested");
			}
	...
	public void testParsePropertyConfigurationsToolSpecificPropvalchange() throws IOException {
		...
		try {
			File dir = new File("target/testinstall");
			if (!dir.exists()) {
				Assert.assertTrue(dir.mkdir());
			}
			FileHelper.copyFile(new File("src/test/resources/env/envPropsToolSpecific02.xml"),
					new File("target/testinstall/env.xml"), true);
			// boot that thing
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env", "target/testinstall/env.xml", "b" }));
			// do not create the "command prompt here" explorer menu entry
			SequenceInputStream sin = new SequenceInputStream(new InputStreamLines(new String[] { "xyz", "n" }));
			ByteArrayOutputStream bStream = new ByteArrayOutputStream();
			PrintStream sout = new PrintStream(bStream);
			...
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env", "target/testinstall/env.xml", "i" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyToolSepcificInst02Win.txt"),
						bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInst02Win.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInst02Win.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificInst02Linux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInst02Linux.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificInst02Linux.cmd"), env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not yet tested");
			}
			...
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			FileHelper.copyFile(new File("src/test/resources/env/envPropsToolSpecificOtherPropvalCommon.xml"),
					new File("target/testinstall/env.xml"), true);
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "target/testinstall/env.xml", "u", "otherapp" }));
			env.execute(sin, sout);
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificUpdate02Win.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificUpdate02Win.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificUpdate02Win.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyToolSepcificUpdate02Linux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificUpdate02Linux.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyToolSpecificUpdate02Linux.cmd"),
						env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not yet tested");
			...
			if (new File("target/testinstall/env.xml").exists()) {
				Assert.assertTrue(new File("target/testinstall/env.xml").delete());
			}
			RapidEnvTestHelper.tearDownProfile(env);
		}
	}
	...
	public void testParsePropertyConfigurationsWithPathextensions() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env", "src/test/resources/env/envWithPathext.xml", "b" });
		...
		switch (PlatformHelper.getOsfamily()) {
		case windows:
			assertTrue("cmd.path = \"" + env.getPropertyValue("cmd.path") + "\"",
					env.getPropertyValue("cmd.path").startsWith(DRIVE_LETTER + ":\\h\\opt\\maven\\bin;"));
			break;
		default:
			assertTrue("cmd.path = \"" + env.getPropertyValue("cmd.path") + "\"",
					env.getPropertyValue("cmd.path").startsWith("/h/opt/maven/bin:"));
			break;
		}
	}
	...
	public void testParsePropertyConfigurationsWithPathextensionsWithBraces() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env", "src/test/resources/env/envWithPathextBraces.xml", "b" });
		RapidEnvInterpreter env = new RapidEnvInterpreter(cmd);
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		assertEquals(3, env.getPropertiesToProcess().size());
		env.initProperties(CmdRenvCommand.boot);
	...
	public void testParsePropertyConfigurationsWithPathextensionsWithBraces2() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env", "src/test/resources/env/envWithPathext.xml", "b" });
		RapidEnvInterpreter env = new RapidEnvInterpreter(cmd,
				new AntGateway(new File("src/test/resources/ant/ant02_win.properties")));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		assertEquals(3, env.getPropertiesToProcess().size());
		env.initProperties(CmdRenvCommand.boot);
	}
	...
	public void testParsePropertyConfigurationsWithPathextensionsWithBracesNoInterpret() {
		CmdRenv cmd = new CmdRenv(
				new String[] { "-env", "src/test/resources/env/envWithPathextBracesNoInterpret.xml", "b" });
		RapidEnvInterpreter env = new RapidEnvInterpreter(cmd);
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		assertEquals(3, env.getPropertiesToProcess().size());
		env.initProperties(CmdRenvCommand.boot);
	...
	public void testInstallFromSourceurlFile() {
		...
		if (new File("target/testinstall/myapp").exists()) {
			FileHelper.deleteDeep(new File("target/testinstall/myapp"));
		}
		assertFalse(new File("target/testinstall/myapp/1.0.2/readme.txt").exists());
		RapidEnvInterpreter env1 = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envTestInstall.xml", "s", "myapp" }));
		...
		try {
			RapidEnvInterpreter env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envTestInstall.xml", "i", "myapp" }));
			...
			assertTrue(new File("target/testinstall/myapp/1.0.2/readme.txt").exists());

			RapidEnvInterpreter env2 = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envTestInstall.xml", "s", "myapp" }));
	 ...
	 * install unit is specified with its simple tool name it's found as long as the
	 * tool name is not ambigouus.
	 */
	@Test
	public void testInstallUnitsToProcessSimple() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "s", "maven", "jdk" }));
	...
	/**
	 * Specify the all install units to process by specifying no install unit with
	 * the command.
	 */
	@Test
	public void testInstallUnitsToProcessAll() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "s" }));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
	...
	/**
	 * Specify the install units to process specifically with the command. If an
	 * install unit is specified with its simple tool name but it is ambigouus we
	 * will get an exception.
	 */
	@Test(expected = RapidEnvCmdException.class)
	public void testInstallUnitsToProcessAmbigouus() {
		try {
			RapidEnvInterpreter renv = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "s", "ant", "ambitool" }));
	...
	/**
	 * Specify the install units to process specifically with the command. Install
	 * units defined more than once only will produce a warning in the log.
	 */
	@Test
	public void testInstallUnitsToProcessRepeat() {
		LoggerMock loggerMock = LoggerMock.getLogger(RapidEnvInterpreter.class.getName());
		RapidEnvInterpreter renv = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "s", "ant", "ant" }), loggerMock);
		renv.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
	...
	/**
	 * Specify the install units to process specifically with the command as fully
	 * qualified names. If an install unit is specified with its fully qualified
	 * tool name it's always found.
	 */
	@Test
	public void testInstallUnitsToProcessFully() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
				"src/test/resources/env/env.xml", "s", "org.apache.maven", "jdk", "org.rapidbeans.alt.ambitool" }));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
	...
	public void testSpecInstallUnitInvalid() {
		try {
			RapidEnvInterpreter renv = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "b", "jdk", "ant", "xxx" }));
			renv.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		} catch (RapidEnvCmdException e) {
			assertTrue(e.getMessage()
					.startsWith("No install unit or property \"xxx\"\n"
							+ "  is defined in RapidEnv environment configuration file\n  \""
							+ new File("src/test/resources/env/env.xml").getAbsolutePath() + "\""));
			throw e;
		}
	}

	/**
	 * Specify a subunit to process specifically with the command as name without
	 * the parent unit path.
	 */
	@Test
	public void testInstallUnitsToProcessSubunitWithoutParentsName() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "s", "serializer" }));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
	...
	/**
	 * Specify a subunit to process specifically with the command as fully qualified
	 * name without the parent unit path.
	 */
	@Test
	public void testInstallUnitsToProcessSubunitWithoutParentsNameFully() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "s", "xalan.serializer" }));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
		assertEquals(1, env.getInstallunitsToProcess().size());
		assertEquals("org.apache.ant/xalan.serializer", env.getInstallunitsToProcess().get(0).getFullyQualifiedName());
	}

	// Complex test installing and updating successively units with partially
	// mandatory and partially optional subunits
	@Test
	public void testUpdateUnitsWithSubunits() {
		try {
			...
			RapidEnvInterpreter env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envDepSub03.xml", "s" }));
			...
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envDepSub03.xml", "i", "test1" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			assertTrue(new File("target/testtargetdir/test1/1.0.0/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/1.0.0/test11").exists());
			assertFalse(new File("target/testtargetdir/test1/1.0.0/test12").exists());
			assertTrue(new File("target/testtargetdir/test1/1.0.0/test13/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/1.0.0/test14").exists());
			...
			env = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "src/test/resources/env/envDepSub03.xml", "i", "test11", "test12" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			assertTrue(new File("target/testtargetdir/test1/1.0.0/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/1.0.0/test11/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/1.0.0/test12/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/1.0.0/test12/test121/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/1.0.0/test12/test122/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/1.0.0/test13/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/1.0.0/test14").exists());

			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envDepSub03a.xml", "u", "test1" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			// Only these optional subunits should be installed that where
			// installed before
			assertFalse(new File("target/testtargetdir/test1/1.0.0").exists());
			assertTrue(new File("target/testtargetdir/test1/2.0.0/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/2.0.0/test11/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/2.0.0/test12/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/2.0.0/test12/test121/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/2.0.0/test12/test122/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/2.0.0/test13/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/2.0.0/test14").exists());

			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envDepSub03a.xml", "d", "test13" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			// Only these optional subunits should be installed that where
			...
			assertFalse(new File("target/testtargetdir/test1/2.0.0/test12/test121/dummy.txt").exists());
			assertTrue(new File("target/testtargetdir/test1/2.0.0/test12/test122/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/2.0.0/test13/dummy.txt").exists());
			assertFalse(new File("target/testtargetdir/test1/2.0.0/test14").exists());

			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envDepSub03a.xml", "s" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			sOut = bosOut.toString().replace("\r\n", "\n");
			...
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envDepSub03a2.xml", "s" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			sOut = bosOut.toString().replace("\r\n", "\n");
	...
	public void testConfugrationInvalidFileNotFound() {
		try {
			new RapidEnvInterpreter(new CmdRenv(new String[] { "-env", "src/test/resources/env/envXXX.xml", "s" }));
		} catch (RapidEnvConfigurationException e) {
			switch (PlatformHelper.getOsfamily()) {
			case windows:
				assertTrue(String.format("got @%s@", e.getMessage()),
						e.getMessage()
								.matches("RapidEnv configuration file \""
										+ ".*\\\\rapidenv-tool\\\\src\\\\test\\\\resources\\\\env\\\\envXXX.xml\" "
										+ "not found"));
				break;
			default:
				assertTrue(e.getMessage().matches("RapidEnv configuration file \""
						+ ".*/rapidenv-tool/src/test/resources/env/envXXX.xml\" " + "not found"));
				break;
			}
		}
	}
	...
	public void testConfugrationInvalidToolTwice() {
		try {
			new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envInvalidToolTwice.xml", "s" }));
		} catch (RapidEnvConfigurationException e) {
	...
	public void testConfugrationInvalidPropTwice() {
		try {
			new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envInvalidPropTwice.xml", "s" }));
		} catch (RapidEnvConfigurationException e) {
	...
	public void testPropertiesStat() throws IOException {
		...
		// set up the profile
		RapidEnvInterpreter env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envProps01.xml", "s" }));
		...
		case windows:
			RapidEnvTestHelper.assertFilesEqual(
					new File("src/test/resources/out/outPropertyCommonChangedStatWin.properties"),
					env.getProfileProps());
			RapidEnvTestHelper.assertFilesEqual(new File("src/test/resources/out/outPropertyCommonChangedStat.cmd"),
					env.getProfileCmd());
			break;
		case linux:
			break;
		default:
			fail("Platform \"" + PlatformHelper.getOsfamily().name() + "\" not supported.");
		}
		RapidEnvInterpreter.clearInstance();
		...
		switch (PlatformHelper.getOsfamily()) {
		case windows:
			RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyCommonChangedStatWin.txt"),
					bStream);
			RapidEnvTestHelper.assertFilesEqual(
					new File("src/test/resources/out/outPropertyCommonChangedStatWin.properties"),
					env.getProfileProps());
			...
			break;
		case linux:
			RapidEnvTestHelper.assertOutput(new File("src/test/resources/out/outPropertyCommonChangedStatUnix.txt"),
					bStream);
			RapidEnvTestHelper.assertFilesEqual(
					new File("src/test/resources/out/outPropertyCommonChangedStatUnix.properties"),
					env.getProfileProps());
			RapidEnvTestHelper.assertFilesEqual(new File("src/test/resources/out/outPropertyCommonChangedStat.sh"),
					env.getProfileCmd());
			break;
		case mac:
	...
	public void testPropertiesConfigure() throws IOException {
		...
		env = new RapidEnvInterpreter(
				new CmdRenv(new String[] { "-env", "src/test/resources/env/envProps01.xml", "c" }));
		try {
			assertNull(env.getPropertyValue("testprop01"));
			...
			case windows:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyCommonChangedConfigWin.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyCommonChangedConfigWin.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyCommonChangedConfig.cmd"), env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(
						new File("src/test/resources/out/outPropertyCommonChangedConfigLinux.txt"), bStream);
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyCommonChangedConfigLinux.properties"),
						env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(
						new File("src/test/resources/out/outPropertyCommonChangedConfig.sh"), env.getProfileCmd());
				break;
			case mac:
				Assert.fail("Mac not yet tested");
				break;
	...
	public void testPathWithExtensionsSimple() throws IOException {
		...
		try {
			...
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath01.xml", "s" }));
			...
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath01.xml", "b" }));
			...
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath02.xml", "u" }));
			...
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath03.xml", "u" }));
			sin = new ByteArrayInputStream("n\n".getBytes());
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			env.execute(sin, sout);
			...
			if (new File("target/testinstall/otherapp").exists()) {
				FileHelper.deleteDeep(new File("target/testinstall/otherapp"));
			}
		}
	}
	...
	public void testPathWithExtesionsInstallunitHomedir() throws IOException {
		...
		try {
			...
			// cmd.path=/x1:/x2:/x3 (linux) or \x1;x2\x3 (win)
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath04.xml", "s" }));
			String originalPath = File.separator + "x1" + File.pathSeparator + File.separator + "x2"
					+ File.pathSeparator + File.separator + "x3";
			env.setPropertyValue("cmd.path", originalPath);
			env.writeProfile();
			...
			// test booting the path property
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath04.xml", "b" }));
			ByteArrayInputStream sin = new ByteArrayInputStream("n\n".getBytes());
			ByteArrayOutputStream bStream = new ByteArrayOutputStream();
			PrintStream sout = new PrintStream(bStream);
			env.execute(sin, sout);
			...
			assertEquals(
					File.separator + "p1" + File.pathSeparator + File.separator + "p2" + File.pathSeparator
							...
							+ new File("target/testinstall/myapp/1.0.2").getAbsolutePath() + File.pathSeparator
							+ new File("target/testinstall/otherapp/1.0").getAbsolutePath(),
					env.getPropertyValue("cmd.path"));
			RapidEnvInterpreter.clearInstance();

			// test upgrading unit otherapp from version 1.0 to 2.0
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath05.xml", "u" }));
			sin = new ByteArrayInputStream("".getBytes());
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			env.execute(sin, sout);
			...
			assertEquals(
					File.separator + "p1" + File.pathSeparator + File.separator + "p2" + File.pathSeparator
							...
							+ File.separator + "a2" + File.pathSeparator
							+ new File("target/testinstall/myapp/1.0.2").getAbsolutePath() + File.pathSeparator
							+ new File("target/testinstall/otherapp/2.0").getAbsolutePath(),
					env.getPropertyValue("cmd.path"));
			RapidEnvInterpreter.clearInstance();

			// test downgrading unit otherapp from version 2.0 to 1.0
			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath04.xml", "u" }));
			sin = new ByteArrayInputStream("".getBytes());
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			env.execute(sin, sout);
	...
	public void testPathWithExtesionsInstallunitHomedirAndPersonal() throws IOException {
		...
		try {
			...
			RapidEnvInterpreter env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath06.xml", "b" }));
			try {
				// do not create the command prompt here explorer entry
				SequenceInputStream sin = new SequenceInputStream(new InputStreamLines(
						new String[] { "pathComponent1" + File.pathSeparator + "pathComponent2", "N" }));
				ByteArrayOutputStream bStream = new ByteArrayOutputStream();
				PrintStream sout = new PrintStream(bStream);
				env.execute(sin, sout);
				assertEquals("pathComponent1" + File.pathSeparator + "pathComponent2",
						env.getPropertyValue("cmd.path.system"));
				assertEquals(File.separator + "fixed" + File.separator + "extension" + File.pathSeparator
						+ "pathComponent1" + File.pathSeparator + "pathComponent2", env.getPropertyValue("cmd.path"));
				RapidEnvInterpreter.clearInstance();

				// test installing units myapp 1.0.2 and otherapp 1.0
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath06.xml", "i" }));
				...
				assertEquals("pathComponent1" + File.pathSeparator + "pathComponent2",
						env.getPropertyValue("cmd.path.system"));
				assertEquals(new File("target/testinstall/myapp/1.0.2").getAbsolutePath() + File.separator + "bin"
						+ File.pathSeparator + new File("target/testinstall/otherapp/1.0").getAbsolutePath()
				...
				// version 1.0 to 2.0
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath07.xml", "s" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				assertTrue(
						bStream.toString().contains("toolhome.otherapp: value of common property should be changed"));
				assertTrue(bStream.toString()
						.contains("cmd.path.system = \"pathComponent1" + File.pathSeparator + "pathComponent2\""));
				...
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath07.xml", "u" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				assertEquals(new File("target/testinstall/otherapp/2.0").getAbsolutePath(),
						env.getPropertyValue("toolhome.otherapp"));
				assertEquals("pathComponent1" + File.pathSeparator + "pathComponent2",
						env.getPropertyValue("cmd.path.system"));
				assertEquals(new File("target/testinstall/myapp/1.0.2").getAbsolutePath() + File.separator + "bin"
						+ File.pathSeparator + new File("target/testinstall/otherapp/2.0").getAbsolutePath()
						+ File.separator + "bin" + File.pathSeparator + File.separator + "fixed" + File.separator
						+ "extension" + File.pathSeparator + "pathComponent1" + File.pathSeparator + "pathComponent2",
						env.getPropertyValue("cmd.path"));
				RapidEnvInterpreter.clearInstance();
				...
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath06.xml", "u" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				assertEquals("pathComponent1" + File.pathSeparator + "pathComponent2",
						env.getPropertyValue("cmd.path.system"));
				assertEquals(new File("target/testinstall/otherapp/1.0").getAbsolutePath(),
						env.getPropertyValue("toolhome.otherapp"));
				assertEquals(new File("target/testinstall/myapp/1.0.2").getAbsolutePath() + File.separator + "bin"
						+ File.pathSeparator + new File("target/testinstall/otherapp/1.0").getAbsolutePath()
						+ File.separator + "bin" + File.pathSeparator + File.separator + "fixed" + File.separator
	...
	@Test
	public void testPathWithExtesionsInstallunitHomedirAndPersonalOptional() throws IOException {
		...
		try {
			...
			// and cmd.path contains cmd.pat.system (profile is empty)
			RapidEnvInterpreter env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath08.xml", "b" }));
			try {
				// do not create the command prompt here explorer entry
				SequenceInputStream sin = new SequenceInputStream(new InputStreamLines(
						new String[] { "pathComponent1" + File.pathSeparator + "pathComponent2", "N" }));
				...
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath08.xml", "i" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				assertEquals("pathComponent1" + File.pathSeparator + "pathComponent2",
						env.getPropertyValue("cmd.path.system"));
				assertEquals(
						new File("target/testinstall/myapp/1.0.2").getAbsolutePath() + File.separator + "bin"
				...
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath08.xml", "s" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				env = new RapidEnvInterpreter(new CmdRenv(
						new String[] { "-env", "src/test/resources/env/envPropsPath08.xml", "i", "otherapp" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				// test upgrading otherapp to version 2.0
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath09.xml", "u" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				// version 1.0 to 2.0
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath09.xml", "s" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				// test downgrading otherapp to version 1.0 again
				env = new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/envPropsPath08.xml", "u" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
	...
	public void testLogLevelVerbose() {
		assertEquals(Level.FINE,
				new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "-verbose", "s" }))
								.getLogLevel());
	}
	...
	public void testLogLevelDebug() {
		assertEquals(Level.FINER,
				new RapidEnvInterpreter(
						new CmdRenv(new String[] { "-env", "src/test/resources/env/env.xml", "-debug", "s" }))
								.getLogLevel());
	}

	@Test
	public void testInitEnvironmentInstallunitsFileWithLocalData() {
		try {
			if (new File("target/testtargetdir").exists()) {
				FileHelper.deleteDeep(new File("target/testtargetdir"));
			}
	...
	public void testDeleteConfigFileAndFolder() {
		try {
			...
			RapidEnvInterpreter env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envMyappSimple.xml", "i", "myapp" }));
			ByteArrayOutputStream bosOut = new ByteArrayOutputStream();
			PrintStream psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			assertTrue(new File("target/testinstall/myapp/1.0.2").exists());
			assertTrue(new File("target/testinstall/myapp/1.0.2/testfile1.txt").exists());
			assertTrue(new File("target/testinstall/myapp/1.0.2/folder1/testfile2.txt").exists());

			env = new RapidEnvInterpreter(
					new CmdRenv(new String[] { "-env", "src/test/resources/env/envFileFolderDel.xml", "u", "myapp" }));
			bosOut = new ByteArrayOutputStream();
			psOut = new PrintStream(bosOut);
			env.execute(System.in, psOut);
			assertTrue(new File("target/testinstall/myapp/1.0.2").exists());
			assertFalse(new File("target/testinstall/myapp/1.0.2/testfile1.txt").exists());
			assertFalse(new File("target/testinstall/myapp/1.0.2/folder1").exists());
		} finally {
			if (new File("target/testtargetdir").exists()) {
				FileHelper.deleteDeep(new File("target/testtargetdir"));
			}
	...
	private static class InputStreamLines implements Enumeration<InputStream> {
		 ...
		 *
		 * @param lineArray a string array with lines to enter
		 */
