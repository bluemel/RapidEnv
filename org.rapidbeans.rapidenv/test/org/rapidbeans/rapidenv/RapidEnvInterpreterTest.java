...
public class RapidEnvInterpreterTest {
	...
	final static String PROJECT_DIR = new File(".").getAbsolutePath()
			.substring(0, new File(".").getAbsolutePath().length() - 2);
	...
	public void testCreateConfigurationWindowsSimple() {
		...
		FileHelper.copyFile(new File("testdata/conf/mysql/mysql.ico"),
				new File("testdata/testinstall/mysql/5.5.15/bin/mysql.ico"),
				true);
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/envIcon01.xml", "c" }));
		...
		final Installunit unitMysql = project
				.findInstallunitConfiguration("mysql");
		ShellLinkIcon icon = (ShellLinkIcon) unitMysql.getConfigurations().get(
				0);
		File shortcutFile = new File(System.getenv("USERPROFILE")
		...
		try {
			...
			assertEquals(env.getProject().findInstallunitConfiguration("mysql")
					.getHomedirAsFile().getAbsolutePath()
			...
			assertEquals("mysqld_start.cmd", icon.getArguments().get(1)
					.getValue());
			...
			ShellLinkWindows shellLinkWinRead = new ShellLinkWindows(
					shortcutFile);
			shellLinkWinRead.load();
			assertEquals("Start TestMySQL.lnk", shellLinkWinRead.getFile()
					.getName());
			assertNotNull(shellLinkWinRead.getTargetPath());
			assertEquals(new File(System.getenv("SystemRoot")
					+ "/system32/cmd.exe").getAbsolutePath(), shellLinkWinRead
					.getTargetPath().getAbsolutePath());
			assertEquals(
					new File(unitMysql.getHomedir() + "/bin").getAbsolutePath(),
					shellLinkWinRead.getWorkingDirectory().getAbsolutePath());
			assertEquals(
					new File(unitMysql.getHomedir() + "/bin/mysql.ico")
							.getAbsolutePath(),
			...
			assertEquals("/C", shellLinkWinRead.getArguments().get(0)
					.getValue());
			assertEquals("mysqld_start.cmd", shellLinkWinRead.getArguments()
					.get(1).getValue());
		} finally {
	...
	public void testCreateConfigurationWindowsCmd() {
		...
		FileHelper
				.copyFile(
						new File("testdata/conf/mysql/mysqld_start.cmd"),
						new File(
								"testdata/testinstall/mysql/5.5.15/bin/mysqld_start.cmd"),
						true);
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/envIcon01.xml", "c" }));
		ByteArrayOutputStream bStream = new ByteArrayOutputStream();
		...
		try {
			...
			assertEquals("argval2 argval3", icon.getArguments().get(1)
					.getValue());
			...
			assertEquals("/C", shellLinkWinRead.getArguments().get(0)
					.getValue());
			assertEquals(false, shellLinkWinRead.getArguments().get(0)
					.getQuoted());
			assertEquals("call", shellLinkWinRead.getArguments().get(1)
					.getValue());
			assertEquals(false, shellLinkWinRead.getArguments().get(1)
					.getQuoted());
			assertEquals(new File(unitMysql.getHomedir()
					+ "/bin/mysqld_start.cmd").getAbsolutePath(),
					shellLinkWinRead.getArguments().get(2).getValue());
			assertEquals(true, shellLinkWinRead.getArguments().get(2)
					.getQuoted());
			assertEquals("argval1", shellLinkWinRead.getArguments().get(3)
					.getValue());
			assertEquals(false, shellLinkWinRead.getArguments().get(3)
					.getQuoted());
			assertEquals("argval2 argval3", shellLinkWinRead.getArguments()
					.get(4).getValue());
			assertEquals(true, shellLinkWinRead.getArguments().get(4)
					.getQuoted());
		} finally {
			if (testinstall.exists()) {
				FileHelper.deleteDeep(testinstall, true);
	...
	public void testCreateConfigurationWindowsCmdenv() {
		...
		try {
			...
			assertEquals(false, shellLinkWinRead.getArguments().get(1)
					.getQuoted());
			assertEquals(env.getProfileCmd().getAbsolutePath(),
					shellLinkWinRead.getArguments().get(2).getValue());
			assertEquals(true, shellLinkWinRead.getArguments().get(2)
					.getQuoted());
			...
			assertEquals(false, shellLinkWinRead.getArguments().get(3)
					.getQuoted());
			assertEquals("call", shellLinkWinRead.getArguments().get(4)
					.getValue());
			assertEquals(false, shellLinkWinRead.getArguments().get(4)
					.getQuoted());
			assertEquals(new File(unitMysql.getHomedir()
					+ "/bin/mysqld_start.cmd").getAbsolutePath(),
					shellLinkWinRead.getArguments().get(5).getValue());
			assertEquals(true, shellLinkWinRead.getArguments().get(5)
					.getQuoted());
			assertEquals("argval1", shellLinkWinRead.getArguments().get(6)
					.getValue());
			assertEquals(false, shellLinkWinRead.getArguments().get(6)
					.getQuoted());
			assertEquals("argval2 argval3", shellLinkWinRead.getArguments()
					.get(7).getValue());
			assertEquals(true, shellLinkWinRead.getArguments().get(7)
					.getQuoted());
		} finally {
			if (testinstall.exists()) {
				FileHelper.deleteDeep(testinstall, true);
	...
	public void testParsePropertyConfigurationsSimple() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/env.xml", "b" }));
	 ...
	 */
	@Test
	public void testParsePropertyConfigurationsToolSpecific()
			throws IOException {

		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/envPropsToolSpecific.xml",
						"s" }));
		RapidEnvInterpreter.clearInstance();
		...
		try {
			...
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envPropsToolSpecific.xml", "b" }));
			SequenceInputStream sin = new SequenceInputStream(
					new InputStreamLines(new String[] { "xyz", "n" // do
																	// not
																	// create
																	// the
																	// "command prompt here"
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificBootWin.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificBootWin.cmd"), env
						.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificBootLinux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificBootLinux.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificBootLinux.cmd"),
						env.getProfileCmd());
				break;
			default:
			...
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificStatLinux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInstWin.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificInstWin.cmd"), env
						.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificInstLinux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInstLinux.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificInstLinux.cmd"),
						env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOs().name()
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInstWinSpec.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificInstWinSpec.cmd"),
						env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper
						.assertOutput(
								new File(
										"testdata/out/outPropertyToolSepcificInstSpecLinux.txt"),
								bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInstLinuxSpec.properties"),
								env.getProfileProps());
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInstLinuxSpec.cmd"),
								env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOs().name()
			...
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificStat2Linux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
			...
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificConfLinux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
			...
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificConfcLinux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
			...
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificConfpLinux.txt"),
						bStream);
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOs().name()
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificDeinstWin.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificDeinstWin.cmd"),
						env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificDeinstLinux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificDeinstLinux.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificDeinstLinux.cmd"),
						env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOs().name()
	...
	public void testParsePropertyConfigurationsToolSpecificPropvalchange()
		...
		try {
			...
			// boot that thing
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envPropsToolSpecific02.xml", "b" }));
			// do not create the "command prompt here" explorer menu entry
			SequenceInputStream sin = new SequenceInputStream(
					new InputStreamLines(new String[] { "xyz", "n" }));
			ByteArrayOutputStream bStream = new ByteArrayOutputStream();
			PrintStream sout = new PrintStream(bStream);
			env.execute(sin, sout);
			switch (PlatformHelper.getOs()) {
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInst02Win.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificInst02Win.cmd"),
						env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper.assertOutput(new File(
						"testdata/out/outPropertyToolSepcificInst02Linux.txt"),
						bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificInst02Linux.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificInst02Linux.cmd"),
						env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOs().name()
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificUpdate02Win.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyToolSpecificUpdate02Win.cmd"),
						env.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper
						.assertOutput(
								new File(
										"testdata/out/outPropertyToolSepcificUpdate02Linux.txt"),
								bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificUpdate02Linux.properties"),
								env.getProfileProps());
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyToolSpecificUpdate02Linux.cmd"),
								env.getProfileCmd());
				break;
			default:
				fail("Platform \"" + PlatformHelper.getOs().name()
	...
	public void testParsePropertyConfigurationsWithPathextensions() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env",
				"testdata/env/envWithPathext.xml", "b" });
		...
		case windows:
			assertTrue(
					...
					env.getPropertyValue("cmd.path").startsWith(
							DRIVE_LETTER + ":\\h\\opt\\maven\\bin;"));
			break;
		default:
			assertTrue(
					"cmd.path = \"" + env.getPropertyValue("cmd.path") + "\"",
	...
	public void testParsePropertyConfigurationsWithPathextensionsWithBraces() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env",
				"testdata/env/envWithPathextBraces.xml", "b" });
		RapidEnvInterpreter env = new RapidEnvInterpreter(cmd);
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		assertEquals(3, env.getPropertiesToProcess().size());
		env.initProperties(CmdRenvCommand.boot);
	...
	public void testParsePropertyConfigurationsWithPathextensionsWithBraces2() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env",
				"testdata/env/envWithPathext.xml", "b" });
		RapidEnvInterpreter env = new RapidEnvInterpreter(cmd, new AntGateway(
				new File("testdata/ant/ant02_win.properties")));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		assertEquals(3, env.getPropertiesToProcess().size());
		env.initProperties(CmdRenvCommand.boot);
	}
	...
	public void testParsePropertyConfigurationsWithPathextensionsWithBracesNoInterpret() {
		CmdRenv cmd = new CmdRenv(new String[] { "-env",
				"testdata/env/envWithPathextBracesNoInterpret.xml", "b" });
		RapidEnvInterpreter env = new RapidEnvInterpreter(cmd);
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.boot);
		assertEquals(3, env.getPropertiesToProcess().size());
		env.initProperties(CmdRenvCommand.boot);
	...
	public void testInstallFromSourceurlFile() {
		...
		assertFalse(new File("testdata/testinstall/myapp/1.0.2/readme.txt")
				.exists());

		try {
			RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "testdata/env/envTestInstall.xml",
							"i", "myapp" }));
			...
			assertTrue(new File("testdata/testinstall/myapp/1.0.2/readme.txt")
					.exists());
		} finally {
			if (new File("testdata/testinstall/myapp").exists()) {
				FileHelper.deleteDeep(new File("testdata/testinstall/myapp"));
	...
	public void testInstallUnitsToProcessSimple() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/env.xml", "s", "maven",
						"jdk" }));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
		assertEquals(2, env.getInstallunitsToProcess().size());
		assertEquals("org.apache.maven", env.getInstallunitsToProcess().get(0)
				.getFullyQualifiedName());
		assertEquals("jdk", env.getInstallunitsToProcess().get(1)
				.getFullyQualifiedName());
	}
	...
	public void testInstallUnitsToProcessAll() {
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/env.xml", "s" }));
		env.initPropertiesAndInstallunitsToProcess(CmdRenvCommand.stat);
		assertEquals(6, env.getInstallunitsToProcess().size());
		assertEquals("jdk", env.getInstallunitsToProcess().get(0)
				.getFullyQualifiedName());
		assertEquals("org.apache.ant", env.getInstallunitsToProcess().get(1)
				.getFullyQualifiedName());
		assertEquals("org.apache.ant/xalan.serializer", env
				.getInstallunitsToProcess().get(2).getFullyQualifiedName());
		assertEquals("org.apache.maven", env.getInstallunitsToProcess().get(3)
				.getFullyQualifiedName());
		assertEquals("org.rapidbeans.ambitool", env.getInstallunitsToProcess()
				.get(4).getFullyQualifiedName());
		assertEquals("org.rapidbeans.alt.ambitool", env
				.getInstallunitsToProcess().get(5).getFullyQualifiedName());
	}
	...
	public void testInstallUnitsToProcessAmbigouus() {
		try {
			...
			assertEquals("Ambigouus tool name \"ambitool\""
					+ " has been specified with the command", e.getMessage());
			throw e;
		}
	}
	...
	public void testInstallUnitsToProcessRepeat() {
		LoggerMock loggerMock = LoggerMock.getLogger(RapidEnvInterpreter.class
				.getName());
		RapidEnvInterpreter renv = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/env.xml", "s", "ant",
						"ant" }), loggerMock);
		...
		assertEquals("Install unit \"org.apache.ant\""
				+ " has been specified for one command multiple times",
				loggerMock.getLogRecords().get(0).getMessage());
		assertEquals(Level.WARNING, loggerMock.getLogRecords().get(0)
				.getLevel());
	}
	...
	public void testSpecInstallUnitInvalid() {
		try {
			RapidEnvInterpreter renv = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "testdata/env/env.xml", "b", "jdk",
							"ant", "xxx" }));
	...
	public void testInstallUnitsToProcessSubunitWithoutParentsName() {
		...
		assertEquals("org.apache.ant/xalan.serializer", env
				.getInstallunitsToProcess().get(0).getFullyQualifiedName());
	}
				...
				assertTrue(e
						...
						.matches(
								"RapidEnv configuration file \""
										+ ".*\\\\org.rapidbeans.rapidenv\\\\testdata\\\\env\\\\envXXX.xml\" "
										+ "not found"));
				break;
			default:
				assertTrue(e
						...
						.matches(
								"RapidEnv configuration file \""
										+ ".*/org.rapidbeans.rapidenv/testdata/env/envXXX.xml\" "
										+ "not found"));
				break;
			}
		}
	...
	public void testConfugrationInvalidToolTwice() {
		try {
			new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envInvalidToolTwice.xml", "s" }));
		} catch (RapidEnvConfigurationException e) {
	...
	public void testConfugrationInvalidPropTwice() {
		try {
			new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envInvalidPropTwice.xml", "s" }));
		} catch (RapidEnvConfigurationException e) {
			assertEquals("Property \"java_home\" specified twice",
					e.getMessage());
		}
	}
	...
	public void testPropertiesStat() throws IOException {
		...
		// set up the profile
		RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
				new String[] { "-env", "testdata/env/envProps01.xml", "s" }));
		env.setPropertyValue("testprop02", "oldvalue");
		File jdkHomdir = new File(env.getProject()
				.findInstallunitConfiguration("jdk").getHomedir());
		...
		case windows:
			RapidEnvTestHelper.assertFilesEqual(new File(
					...
					env.getProfileProps());
			RapidEnvTestHelper.assertFilesEqual(new File(
					"testdata/out/outPropertyCommonChangedStat.cmd"), env
					.getProfileCmd());
			break;
		case linux:
			break;
		...
		case linux:
			RapidEnvTestHelper.assertOutput(new File(
					"testdata/out/outPropertyCommonChangedStatUnix.txt"),
					bStream);
			RapidEnvTestHelper
					.assertFilesEqual(
							new File(
									"testdata/out/outPropertyCommonChangedStatUnix.properties"),
							env.getProfileProps());
			RapidEnvTestHelper.assertFilesEqual(new File(
					"testdata/out/outPropertyCommonChangedStat.sh"), env
					.getProfileCmd());
			break;
		}
	...
	public void testPropertiesConfigure() throws IOException {
		...
		env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
				"testdata/env/envProps01.xml", "c" }));
		try {
			assertNull(env.getPropertyValue("testprop01"));
			final ByteArrayInputStream sin = new ByteArrayInputStream(
					"".getBytes());
			final ByteArrayOutputStream bStream = new ByteArrayOutputStream();
			final PrintStream sout = new PrintStream(bStream);
			env.execute(sin, sout);
			...
			assertEquals("D:" + File.separator + "unknown",
					env.getPropertyValue("testprop01"));
			...
			case windows:
				...
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyCommonChangedConfigWin.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyCommonChangedConfig.cmd"), env
						.getProfileCmd());
				break;
			case linux:
				RapidEnvTestHelper
						.assertOutput(
								new File(
										"testdata/out/outPropertyCommonChangedConfigLinux.txt"),
								bStream);
				RapidEnvTestHelper
						.assertFilesEqual(
								new File(
										"testdata/out/outPropertyCommonChangedConfigLinux.properties"),
								env.getProfileProps());
				RapidEnvTestHelper.assertFilesEqual(new File(
						"testdata/out/outPropertyCommonChangedConfig.sh"), env
						.getProfileCmd());
				break;
			}
		} finally {
	...
	public void testPathWithExtensionsSimple() throws IOException {
		...
		String originalPath = File.separator + "x1" + File.pathSeparator
				+ File.separator + "x2" + File.pathSeparator + File.separator
				+ "x3";
		...
		env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
				"testdata/env/envPropsPath01.xml", "b" }));
		...
		assertEquals(File.separator + "p1" + File.pathSeparator
				+ File.separator + "p2" + File.pathSeparator + File.separator
				+ "p3" + File.pathSeparator + File.separator + "x1"
				+ File.pathSeparator + File.separator + "x3"
				+ File.pathSeparator + File.separator + "a1"
				+ File.pathSeparator + File.separator + "a2",
				env.getPropertyValue("cmd.path"));
		RapidEnvInterpreter.clearInstance();

		env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
				"testdata/env/envPropsPath02.xml", "u" }));
		...
		assertEquals(File.separator + "p0" + File.pathSeparator
				+ File.separator + "p1" + File.pathSeparator + File.separator
				+ "p2" + File.pathSeparator + File.separator + "p2a"
				+ File.pathSeparator + File.separator + "p3"
				+ File.pathSeparator + File.separator + "x1"
				+ File.pathSeparator + File.separator + "x3"
				+ File.pathSeparator + File.separator + "a1"
				+ File.pathSeparator + File.separator + "a1a"
				+ File.pathSeparator + File.separator + "a2"
				+ File.pathSeparator + File.separator + "a3",
				env.getPropertyValue("cmd.path"));
		RapidEnvInterpreter.clearInstance();

		env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
				"testdata/env/envPropsPath03.xml", "u" }));
		sin = new ByteArrayInputStream("n\n".getBytes());
		bStream = new ByteArrayOutputStream();
		sout = new PrintStream(bStream);
		env.execute(sin, sout);
	...
	public void testPathWithExtesionsInstallunitHomedir() throws IOException {
		...
		try {
			...
			// cmd.path=/x1:/x2:/x3 (linux) or \x1;x2\x3 (win)
			RapidEnvInterpreter env = new RapidEnvInterpreter(new CmdRenv(
					new String[] { "-env", "testdata/env/envPropsPath04.xml",
							"s" }));
			String originalPath = File.separator + "x1" + File.pathSeparator
					+ File.separator + "x2" + File.pathSeparator
					+ File.separator + "x3";
			env.setPropertyValue("cmd.path", originalPath);
			env.writeProfile();
			RapidEnvInterpreter.clearInstance();
			...
			// test booting the path property
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envPropsPath04.xml", "b" }));
			...
			assertEquals(
					File.separator
							...
							+ "a2"
							+ File.pathSeparator
							+ new File("testdata/testinstall/myapp/1.0.2")
									.getAbsolutePath()
							+ File.pathSeparator
							+ new File("testdata/testinstall/otherapp/1.0")
									.getAbsolutePath(),
					env.getPropertyValue("cmd.path"));
			RapidEnvInterpreter.clearInstance();
			...
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envPropsPath05.xml", "u" }));
			sin = new ByteArrayInputStream("".getBytes());
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			env.execute(sin, sout);
			...
			assertEquals(
					File.separator
							...
							+ new File("testdata/testinstall/myapp/1.0.2")
									.getAbsolutePath()
							+ File.pathSeparator
							+ new File("testdata/testinstall/otherapp/2.0")
									.getAbsolutePath(),
					env.getPropertyValue("cmd.path"));
			RapidEnvInterpreter.clearInstance();
			...
			env = new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
					"testdata/env/envPropsPath04.xml", "u" }));
			sin = new ByteArrayInputStream("".getBytes());
			bStream = new ByteArrayOutputStream();
			sout = new PrintStream(bStream);
			env.execute(sin, sout);
			...
			if (new File("testdata/testinstall/otherapp").exists()) {
				FileHelper
						.deleteDeep(new File("testdata/testinstall/otherapp"));
			}
		}
	}

	@Test
	public void testPathWithExtesionsInstallunitHomedirAndPersonal()
			throws IOException {
		...
		try {
			...
			try {
				...
				assertEquals(
						new File("testdata/testinstall/myapp/1.0.2").getAbsolutePath()
								+ File.separator
								+ "bin"
								+ File.pathSeparator
				...
				env = new RapidEnvInterpreter(new CmdRenv(new String[] {
						"-env", "testdata/env/envPropsPath06.xml", "i" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				// version 1.0 to 2.0
				env = new RapidEnvInterpreter(new CmdRenv(new String[] {
						"-env", "testdata/env/envPropsPath07.xml", "s" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				assertTrue(bStream
						.toString()
						.contains(
								"toolhome.otherapp: value of common property should be changed"));
				assertTrue(bStream.toString().contains(
						"cmd.path.system = \"pathComponent1"
								+ File.pathSeparator + "pathComponent2\""));
				assertTrue(bStream.toString().contains(
						"cmd.path: value of common property should be changed"));
				RapidEnvInterpreter.clearInstance();
				...
				env = new RapidEnvInterpreter(new CmdRenv(new String[] {
						"-env", "testdata/env/envPropsPath07.xml", "u" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
				...
				env = new RapidEnvInterpreter(new CmdRenv(new String[] {
						"-env", "testdata/env/envPropsPath06.xml", "u" }));
				sin = new SequenceInputStream(new InputStreamLines());
				bStream = new ByteArrayOutputStream();
				sout = new PrintStream(bStream);
				env.execute(sin, sout);
	...
	public void testLogLevelDefault() {
		assertEquals(Level.INFO,
				new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
						"testdata/env/env.xml", "s" })).getLogLevel());
	}
	...
	public void testLogLevelVerbose() {
		assertEquals(Level.FINE, new RapidEnvInterpreter(
	...
	public void testLogLevelDebug() {
		assertEquals(Level.FINER,
				new RapidEnvInterpreter(new CmdRenv(new String[] { "-env",
						"testdata/env/env.xml", "-debug", "s" })).getLogLevel());
	}
