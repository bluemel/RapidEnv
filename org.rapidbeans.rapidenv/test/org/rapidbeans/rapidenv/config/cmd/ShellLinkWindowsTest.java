...
public class ShellLinkWindowsTest {
	...
	public void testCreateProgrammatically() {
		...
		shellLink.setTargetPath(new File(System.getenv("SYSTEMROOT") + File.separator + "system32" + File.separator
		        + "cmd.exe"));
		...
		assertEquals(new File("testdata/shelllink/test.ico").getAbsolutePath(), shellLinkRead.getIconFile()
		        .getAbsolutePath());
	...
	public void testReadWindows() {
		...
		ShellLinkWindows shellLink = new ShellLinkWindows(new File("testdata/shelllink/testRead.lnk"));
		shellLink.load();
		assertEquals("This is a test shortcut for reading shortcuts.", shellLink.getDescription());
		assertEquals(new File("testdata/shelllink/testRead.lnk"), shellLink.getFile());
		assertEquals(new File(System.getenv("SYSTEMROOT") + File.separator + "system32" + File.separator + "cmd.exe"),
		        shellLink.getTargetPath());
		assertEquals(System.getenv("SYSTEMROOT") + File.separator + "system32", shellLink.getWorkingDirectory()
		        .getAbsolutePath());
		...
		assertTrue(shellLink.getIconFile().getAbsolutePath()
		        .endsWith("testdata" + File.separator + "shelllink" + File.separator + "test.ico"));
