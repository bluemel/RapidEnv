...
public class ConfigExprTest {
    ...
    public void testSplitFuncnameNormal() {
        ConfigExprSplitResult result =
            ConfigExprParser.splitFuncname("homedir");
    ...
    public void testSplitFuncnameWsBefore() {
        ConfigExprSplitResult result =
            ConfigExprParser.splitFuncname("   hd");
    ...
    public void testSplitFuncnameComplex1() {
        ConfigExprSplitResult result =
            ConfigExprParser.splitFuncname(" a bb ccc hd     ");
        Assert.assertEquals("hd", result.getFuncname());
    ...
    public void testSplitFuncnameComplex2() {
        ConfigExprSplitResult result =
            ConfigExprParser.splitFuncname("123 func");
    ...
    public void testSplitFuncnameComplex3() {
        ConfigExprSplitResult result =
            ConfigExprParser.splitFuncname("D:\\h\\opt\\maven\\bin;D:\\Projects\\RapidBeans\\org.rapidbeans.rapidenv\\testdata\\testinstall\\jdk\\1.6.0\\bintest01;test02 ");
        Assert.assertEquals("D:\\h\\opt\\maven\\bin;D:\\Projects\\RapidBeans\\org.rapidbeans.rapidenv\\testdata\\testinstall\\jdk\\1.6.0\\bintest01;test02", result.getFuncname());
        Assert.assertNull(result.getBefore());
        Assert.assertEquals(" ", result.getWhitespacesAfter());
    }
}
