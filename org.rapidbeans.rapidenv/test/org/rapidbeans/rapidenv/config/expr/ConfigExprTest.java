...
public class ConfigExprTest {
	...
	public void testSplitFuncnameComplex3() {
		ConfigExprSplitResult result = ConfigExprParser
		        .splitFuncname("D:\\h\\opt\\maven\\bin;D:\\Projects\\RapidBeans\\org.rapidbeans.rapidenv\\testdata\\testinstall\\jdk\\1.6.0\\bintest01;test02 ");
		Assert.assertEquals(
		        "D:\\h\\opt\\maven\\bin;D:\\Projects\\RapidBeans\\org.rapidbeans.rapidenv\\testdata\\testinstall\\jdk\\1.6.0\\bintest01;test02",
		        result.getFuncname());
		Assert.assertNull(result.getBefore());
		Assert.assertEquals(" ", result.getWhitespacesAfter());
	}
