...
public class InstallunitTest {
    ...
    public void testSubunits() {
        ...
        Assert.assertEquals(
                new File("testdata/testtargetdir/org/rapidenv/test01/1.0.0").getAbsolutePath(),
    ...
    public void testAmbigoousSubunit() {
        ...
        try {
            ...
            Assert.assertTrue("Unexpected message text start: "
                    + e.getMessage(), e.getMessage().startsWith("Ambigouus tool name"));
            throw e;
        }
    }
    ...
    public void testGetHomedir() {
        ...
        Installunit antXalanSerializer = project.findInstallunitConfiguration(
    ...
    public void testGetHomedirDeep() {
        Document doc = new Document(new File("testdata/env/envDepSub.xml"));
        Project project = (Project) doc.getRoot();
        Installunit test01 = project.findInstallunitConfiguration(
            "org.rapidenv.test01");
        Assert.assertEquals(
        ...
        Installunit test01_1 = project.findInstallunitConfiguration(
            "org.rapidenv.test01/test1");
        Assert.assertEquals(
                "testdata/testtargetdir/org/rapidenv/test01/1.0.0/test1/lib",
                test01_1.getHomedir());
        Installunit test01_2_x = project.findInstallunitConfiguration(
            "org.rapidenv.test01/test2/testx");
        Assert.assertEquals("testdata/testtargetdir/org/rapidenv/test01/1.0.0/test2/testx",
