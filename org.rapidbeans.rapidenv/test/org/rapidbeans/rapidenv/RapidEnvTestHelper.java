...
public class RapidEnvTestHelper {
    ...
    public static void assertFilesEqual(final File file1, final File file2)
            throws IOException {
        ...
        try {
            ...
            while((line1 = rd1.readLine()) != null) {
                ...
                line2 = rd2.readLine();
                if (line2 == null) {
                    fail("Unexpectedly file \""
                            + file1.getAbsolutePath()
                            + "\" misses line " + lineno + ": " + line1);
                }
            ...
            if (line2 != null) {
                fail("Unexpectedly file \""
                        ...
                        + "\" has additional line " + lineno + ": " + line2);
            }
    ...
    public static void assertOutput(final File file, final ByteArrayOutputStream out)
            throws IOException {
        LineNumberReader rd1 = null;
        LineNumberReader rd2 = null;
        try {
