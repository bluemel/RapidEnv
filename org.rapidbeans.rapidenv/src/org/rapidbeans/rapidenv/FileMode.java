...
public class FileMode {
	...
	public FileMode(int mode) {
		...
		if (mode >= 65536)
		{
			throw new AssertionError("Unexpected file mode: " + Integer.toString(mode));
		}
	...
	public String toChmodStringBasic() {
		...
		sb.append(Integer.toString(toOctal(this.userRead, this.userWrite, this.userExecute)));
		sb.append(Integer.toString(toOctal(this.groupRead, this.groupWrite, this.groupExecute)));
		sb.append(Integer.toString(toOctal(this.otherRead, this.otherWrite, this.otherExecute)));
		return sb.toString();
	}

	public String toChmodStringFull() {
		final StringBuilder sb = new StringBuilder(4);
		sb.append(Integer.toString(toOctal(this.setUid, this.setGid, this.stickyBit)));
		sb.append(Integer.toString(toOctal(this.userRead, this.userWrite, this.userExecute)));
		sb.append(Integer.toString(toOctal(this.groupRead, this.groupWrite, this.groupExecute)));
		sb.append(Integer.toString(toOctal(this.otherRead, this.otherWrite, this.otherExecute)));
		return sb.toString();
