...
public class ConfigFolder extends RapidBeanBaseConfigFolder {
     ...
     *
     * @param execute if false only execute the check if the configuration is necessary
    ...
    public boolean check(final boolean execute) {
        ...
        if (getSourceurl() != null) {
            if (url.getProtocol().equals("file")) {
            	RapidEnvInterpreter.log(Level.FINE, "Folder configuration sourceurl = \""
            			+ getSourceurl() + "\"");
            	RapidEnvInterpreter.log(Level.FINE, "");
                sourcefile = new File(url.getFile());
                RapidEnvInterpreter.log(Level.FINE, "Folder configuration sourcefile \""
                ...
                if (!targetfolder.exists()) {
                    if (execute) {
                        ...
                        final String msg = "    unpacked " + sourcefile.getAbsolutePath()
