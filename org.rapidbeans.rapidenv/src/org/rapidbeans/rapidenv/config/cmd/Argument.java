...
public class Argument extends RapidBeanBaseArgument {
    ...
    public String getValue() {
    	...
    	if (env != null) {
    		final String interpreted = env.interpret(
    				parentInstallUnit , null, super.getValue());
    		RapidEnvInterpreter.log(
    				Level.FINER, "Intepreted argument value \""
    				+ super.getValue() + "\" to \""
    				+ interpreted +"\"");
    		return interpreted;
    	} else {
     ...
     *
     * @param value the value string
     * @param quoted if the argument has quotes
     */
