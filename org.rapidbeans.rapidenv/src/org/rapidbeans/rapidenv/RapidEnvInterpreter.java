...
public class RapidEnvInterpreter {
	...
	public String interpret(final Installunit enclosingUnit, final Property enclosingProperty, final String in) {
		return new ConfigExprTopLevel(enclosingUnit, enclosingProperty, in, getProject().getExpressionLiteralEscaping())
		        .interpret();
	}
	...
	public static String interpretStat(final Installunit enclosingUnit, final Property enclosingProperty,
	        final String string) {
		final RapidEnvInterpreter interpreter = getInstance();
		if (interpreter == null || string == null) {
			return string;
		}
		final String interpreted = interpreter.interpret(enclosingUnit, enclosingProperty, string);
		RapidEnvInterpreter.log(Level.FINER, "Interpreted string \"" + string + "\" to\n  \"" + interpreted + "\".");
		return interpreted;
	}
